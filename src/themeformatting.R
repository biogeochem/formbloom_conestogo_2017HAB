theme_std <- function (base_size = 10,
                       base_family = "") {
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
    theme(
      axis.ticks = element_line(colour = "grey80", size = 0.75),
...
theme_pub <- function (base_size = 10,
  ...
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
    theme(
      axis.ticks = element_line(colour = "grey40", size = 0.75),
      ...
      strip.text = element_text(size = rel(1.05), colour = "black"),
      #face = "normal"
      strip.background = element_blank(),
      plot.margin = unit(c(10, 10, 10, 10), "pt")
    )
